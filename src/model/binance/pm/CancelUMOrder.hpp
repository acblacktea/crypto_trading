...
DEFINE_CLASS(
    ...
    ((std::string, avgPrice, avgPrice))((std::string, clientOrderId, clientOrderId))((std::string, cumQty, cumQty))(
        (std::string, cumQuote, cumQuote))((std::string, executedQty, executedQty))((long long, orderId, orderId))(
