...
namespace Binance {
    ...
    private:
        ...
        void setFirstTradePriceBefore24H(std::string &&_firstTradePriceBefore24H) { firstTradePriceBefore24H = std::move(_firstTradePriceBefore24H); }
    ...
    class StatisticsTickerEvent : public JsonObject {
    public:
        bool deserialize(const rapidjson::Value &obj) override;
    ...
    class AllStatisticsTickersEvent : public JsonObject {
    public:
        bool deserialize(const rapidjson::Value &obj) override;
        std::string stream;
