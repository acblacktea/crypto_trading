...
namespace USDM
{
DEFINE_CLASS(ModifyOrderRequestParams((std::string, apiKey, apiKey))((std::string, signature, signature))((std::string, symbol, symbol))(
    (long long, timestamp, timestamp))((std::string, quantity, quantity))((std::string, price, price))(
...
DEFINE_CLASS(ModifyOrderResponseResult(((long long, orderId, orderId))((std::string, symbol, symbol))((std::string, status, status))(
