...
namespace USDM
{
DEFINE_CLASS(QueryOrderRequestParams((std::string, apiKey, apiKey))((std::string, signature, signature))((std::string, symbol, symbol))(
...
DEFINE_CLASS(QueryOrderResponseResult(((long long, orderId, orderId))((std::string, symbol, symbol))((std::string, status, status))(
